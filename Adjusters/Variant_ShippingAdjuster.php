...
use Craft\Commerce_LineItemRecord;
 ...
 */
class Variant_ShippingAdjuster implements Commerce_AdjusterInterface
{
    ...
    public function adjust(Commerce_OrderModel &$order, array $lineItems = [])
    {
        ...
        if ($rule = \Craft\craft()->commerce_shippingMethods->getMatchingShippingRule($order, $shippingMethod))
        {
            ...
            {
				$lineItemRecord = Commerce_LineItemRecord::model()->findById($item->id);
				$item->shippingCategoryId = $lineItemRecord->shippingCategoryId;
